...
const About = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>On this blogfolio, you can find different kinds of blog posts about tech things i found interesting, hard to find, or helpful that i decided to share with the community. You can also find some of my projects that i am eager to share with everyone.</p>
